...
import { FaTrash, FaUpload, FaFileAlt, FaEye, FaBars, FaTimes } from 'react-icons/fa';
    ...
    <div className='journalistContainer'>
      ...
      <main className="journalist">
        ...
        <div className='dashboardCardContainer'>
          <DashboardCard label='Total Terbit' count='50' icon={<FaUpload />} />
          <DashboardCard label='Total Draft' count='50' icon={<FaFileAlt />} />
        </div>
